...
function Badge({ value, colorMap }) {
  ...
  return (
    <span style={{ background: style.bg, color: style.color, fontSize: 11, fontWeight: 600, padding: '2px 8px', borderRadius: 5, whiteSpace: 'nowrap' }}>
      {value || '—'}
    </span>
  );
}
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            ...
            <tbody>
              ...
              {filtered.map((card, idx) => (
                ...
                >
                  <td style={{ padding: '7px 12px', borderBottom: '1px solid #F1F5F9', textAlign: 'center', color: '#CBD5E1', fontSize: 12, fontWeight: 500 }}>
                    {idx + 1}
                  </td>
                  <td style={{ padding: '7px 12px', borderBottom: '1px solid #F1F5F9', color: '#64748B', fontSize: 12, whiteSpace: 'nowrap' }}>
                    {card.parent || '—'}
                  </td>
                  <td style={{ padding: '7px 12px', borderBottom: '1px solid #F1F5F9', fontWeight: 600, color: '#1E3A5F', fontSize: 12, whiteSpace: 'nowrap' }}>
                    {card.card_id}
                  </td>
                  ...
                  <td style={{ padding: '7px 12px', borderBottom: '1px solid #F1F5F9', color: '#1E3A5F', fontWeight: 600, fontSize: 12, textAlign: 'center' }}>
                    {card.estimate > 0 ? card.estimate.toFixed(2) : '—'}
                  </td>
                  <td style={{ padding: '7px 12px', borderBottom: '1px solid #F1F5F9', color: '#F59E0B', fontWeight: 600, fontSize: 12, textAlign: 'center' }}>
